  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved card as @card" do
        ...
        post :create, {:card => { "user" => "invalid value" }}, valid_session
        assigns(:card).should be_a_new(Card)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested card" do
        ...
        Card.any_instance.should_receive(:update_attributes).with({ "user" => "" })
        put :update, {:id => card.to_param, :card => { "user" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the card as @card" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Card.any_instance.stub(:save).and_return(false)
        put :update, {:id => card.to_param, :card => { "user" => "invalid value" }}, valid_session
        assigns(:card).should eq(card)
      end
